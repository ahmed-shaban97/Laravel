    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('posts.update', $post->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{ $post->title }}" name="title" class="form-control" placeholder="Enter post title" required>
            </div>

            <!-- Description -->
            <div class="mb-3">
                <label for="description" class="form-label fw-bold">Description</label>
                <textarea name="description" rows="4" class="form-control" placeholder="Enter post description">{{ $post->description }}</textarea>
            </div>
